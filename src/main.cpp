...
uint256 hashGenesisBlock("0xc40472eab430d18b5702a9bd6c6c60566e5de3d9dbf54b565f9c4e931815f304");
...
const string strMessageMagic = "SannaCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // SannaCoin: 1 days
static const int64 nTargetSpacing = 60; // SannaCoin: 1 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal sannacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SannaCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc40472eab430d18b5702a9bd6c6c60566e5de3d9dbf54b565f9c4e931815f304");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "The coin of Sanna family";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1486620567; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3980673;

        if (fTestNet)
        {
            block.nTime    = 1486620567;
            block.nNonce   = 3980673;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xeda240e080b6d75de358ebc979634a70550c3008295aaf8675f9b3ddd40fef14"));
